...
```
From this confusion matrix, we can see that it predicted not fire correctly in 26 cases, predicted fire correctly in 33 cases and predicted incorrectly in only 1 cases. This means that the accuracy of our model might be quite high. Now, we look at the accuracy metrics using the metrics argument:

...
We can see from table 3 and 4 that the ranges of values for Ws are really similar, which are 8-21 and 6-29. 
And from table 5 and 6, we can see that their averages are also really similar, which are 15.41 and 15.72.

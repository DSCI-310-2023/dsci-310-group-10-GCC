...
We can see from table 2.2.1 and 2.2.2 that the range of values for Ws is really similar, which is 8-21 and 6-29. 
And from the other two tables, we can see that their averages are also really similar, which is 15.41 and 15.72.

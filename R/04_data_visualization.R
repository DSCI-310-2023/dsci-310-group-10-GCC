...
ggsave(here("results/analysis_data/classification_regions.png"), plot = wkflw_plot,
       device = "png")
ggsave(here("results/analysis_data/correlation_graph.png"), plot = fire_train_plot, 

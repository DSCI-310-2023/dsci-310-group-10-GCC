...
knitr::kable(forest_fires[1:10, ], caption = "First 10 entries of the forest fire dataset")
```
...
fire_training_range_fire <- read_csv(here("results/fire_training_range_fire.csv"))
...
fire_training_range_not_fire <- read_csv(here("results/fire_training_range_not_fire.csv"))
...
knitr::include_graphics(here("results/correlation_graph.png"))
```
...
knitr::include_graphics(here("results/scatter_plot.png"))
```
...
knitr::include_graphics(here("results/line_plot.png"))
```
...
fire_test_predictions <- read_csv(here("results/fire_test_predictions.csv"))
...
knitr::include_graphics(here("results/classification_regions.png"))
```
